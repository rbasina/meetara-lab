...
# Add trinity_core to path for imports
...
class WorkingEnhancedFactory:
    ...
    def _load_domain_categories(self):
        ...
        Domain info should be loaded via SmartTrinityConfigManager.
        """
        logger.warning(
            "Attempting to load from a deprecated config file. "
            "Please use the centralized SmartTrinityConfigManager."
        )
        return {}

    def _get_base_model_from_config(self, domain):
        """
        [DEPRECATED] This method is obsolete.
        Model info should be loaded via SmartTrinityConfigManager.
        """
        logger.warning(
            "Attempting to load from a deprecated config file. "
            "Please use the centralized SmartTrinityConfigManager."
        )
        return "microsoft/DialoGPT-medium"  # Fallback
