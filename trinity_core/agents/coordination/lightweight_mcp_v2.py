...
@dataclass
class MCPMessage:
    """Backward compatibility MCP message format"""
...
@dataclass
class MCPResponse:
    """Backward compatibility MCP response format"""
    success: bool
    data: Optional[Dict[str, Any]] = None
    error: Optional[str] = None

class MCPAgent:
    """Backward compatibility base agent class"""
    def __init__(self, agent_type: str = "unknown"):
        self.agent_type = agent_type
    
    async def handle_message(self, message: MCPMessage) -> MCPResponse:
        """Backward compatibility message handler"""
