...
class EnhancedEmotionDetector:
    ...
    def __init__(self, mcp: LightweightMCPv2 = None):
        self.agent_id = "emotion_detector"
        self.mcp = mcp
        if self.mcp:
            self.mcp.register_agent(self.agent_id, self)
    ...
    async def detect_emotion_comprehensive(self, text: str, domain: str = "general",
        ...
        try:
            ...
            if self.mcp:
                ...
                await self.mcp.emit_event(event)
